...
def parse_float_space_thousands(value_str: str, field_name: str) -> Optional[float]:
    """
    ...
    # Must match: digits with optional space-separated groups, optional decimal part
